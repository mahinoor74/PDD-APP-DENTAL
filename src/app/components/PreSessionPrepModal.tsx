...
import { Sparkles, CheckCircle2, Volume2, Play, ShieldAlert, Droplets, Smile, HelpCircle } from "lucide-react";
...
export default function PreSessionPrepModal({
  ...
  // Automatically speak prepScript when modal mounts
  useEffect(() => {
