  ...
  return (
    <div className="space-y-8 pb-24 md:pb-12 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
        ...
        <div className="relative z-10 flex flex-col md:flex-row items-start md:items-center justify-between gap-6">
          ...
          <div className="flex flex-col sm:flex-row items-center gap-3 w-full md:w-auto">
            <button
              ...
              disabled={loading}
              className="w-full sm:w-auto px-5 py-3.5 rounded-2xl bg-white/20 hover:bg-white/30 text-white border border-white/35 font-bold text-xs sm:text-sm backdrop-blur-md flex items-center justify-center gap-2 transition cursor-pointer"
            >
            ...
            <button
              ...
              className="w-full sm:w-auto px-6 py-3.5 rounded-2xl bg-white text-indigo-950 hover:bg-indigo-50 font-black text-xs sm:text-sm shadow-xl shadow-indigo-950/20 flex items-center justify-center gap-2 transform hover:scale-105 transition cursor-pointer"
            >
      ...
      <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
        ...
        <div className="lg:col-span-7 bg-slate-900/90 border border-indigo-500/30 rounded-3xl p-6 shadow-2xl backdrop-blur-xl space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <Calendar className="w-5 h-5 text-indigo-400" />
              <h2 className="text-base font-black text-white">{t('dash_weekly_title')}</h2>
            </div>
            <span className="text-[11px] font-extrabold text-indigo-300 bg-indigo-950/90 px-3 py-1 rounded-full border border-indigo-500/40">
              ...
              return (
                <div
                  ...
                  className={`flex flex-col items-center justify-between p-3 rounded-2xl border transition-all ${
                    isDone
                      ? 'bg-gradient-to-tr from-indigo-500 via-purple-500 to-violet-600 border-indigo-400 text-white shadow-lg shadow-indigo-500/25'
                ...
                >
                  ...
                  <span className="text-[9px] font-bold opacity-80">{isDone ? `${dayData.count}x` : t('dash_missed')}</span>
                </div>
              );
            })}
          </div>
        ...
        <div className="lg:col-span-5 bg-slate-900/90 border border-indigo-500/30 rounded-3xl p-6 shadow-2xl backdrop-blur-xl space-y-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-2.5">
              <Clock className="w-5 h-5 text-indigo-400" />
              <h2 className="text-base font-black text-white">{t('dash_reminders_title')}</h2>
            </div>
            <button
              onClick={() => navigate('/profile')}
              className="text-xs text-indigo-300 hover:text-indigo-200 font-bold hover:underline cursor-pointer flex items-center gap-1"
            >
      ...
      <div className="space-y-4">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-5">
          ...
          <div
            onClick={() => navigate('/smart-mirror')}
            className="group rounded-3xl p-6 bg-slate-900/90 border border-indigo-500/35 hover:border-indigo-400 shadow-xl hover:shadow-2xl hover:shadow-indigo-500/20 hover:-translate-y-1 transition-all cursor-pointer space-y-4"
          >
            <div className="w-12 h-12 rounded-2xl bg-gradient-to-tr from-indigo-500 via-purple-500 to-pink-500 text-white flex items-center justify-center shadow-lg shadow-indigo-500/30 group-hover:scale-110 transition-transform">
            ...
            <div className="flex items-center gap-1.5 text-xs font-black text-indigo-300 group-hover:translate-x-1 transition-transform">
              <span>{t('btn_start_mirror')}</span>
          ...
          >
            ...
            <div className="flex items-center gap-1.5 text-xs font-black text-purple-300 group-hover:translate-x-1 transition-transform">
          ...
          >
            ...
            <div className="flex items-center gap-1.5 text-xs font-black text-cyan-300 group-hover:translate-x-1 transition-transform">
          ...
          >
            ...
            <div className="flex items-center gap-1.5 text-xs font-black text-pink-300 group-hover:translate-x-1 transition-transform">
