export const CLINICAL_TECHNIQUES = [
  {
    id: "modified_bass",
  ...
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/N-0pZ1ZpQ4Y"
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/Y-yM1w7G7dQ"
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/1B1a2a0oG8Q"
  },
  {
    ...
    videoUrl: "https://www.youtube.com/embed/jD-J8Z2n984"
  },
  {
    id: "roll_sweep",
  ...
  },
  {
    ...
    steps: [
      "Stick your tongue out fully in front of a mirror.",
      "Place tongue cleaner or soft brush head at the posterior third of the tongue.",
      "Apply light pressure and drag forward in one continuous motion.",
      "Rinse debris off cleaner under tap water and repeat 3-4 times."
    ],
    precautions: [
      "Do not place scraper too far back to prevent triggering gag reflex.",
      "Use light pressure to avoid scraping lingual papillae.",
      "Rinse scraper thoroughly between passes."
    ],
    videoUrl: "https://www.youtube.com/embed/1B1a2a0oG8Q"
  },
  {
    ...
    steps: [
      "Guide 18 inches of dental floss gently between teeth using a sawing motion.",
      "Curve floss into a C-shape around the side of the tooth at the gumline.",
      "Slide floss up and down against the tooth surface to scrape away plaque.",
      "Unroll a fresh section of floss as you move to each interdental space."
    ],
    precautions: [
      "Never snap floss hard down into gum tissue to prevent lacerations.",
      "Always use clean unrolled sections for each tooth space.",
      "Pair with interdental brushes if spaces are wide."
    ],
    videoUrl: "https://www.youtube.com/embed/jD-J8Z2n984"
  }
];
